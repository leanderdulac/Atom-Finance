...
const BinanceDashboard: React.FC = () => {
  ...
  const [kellyError, setKellyError] = useState('');
  ...
  const handleCalculateKelly = async () => {
    ...
    try {
      ...
      setKellyError(e instanceof Error ? e.message : 'Kelly calculation failed');
      setKellyResult(null);
    } finally {
                ...
                <CardContent>
                  ...
                  <Grid container spacing={2}>
                    ...
                    <Grid size={{ xs: 12 }}>
                      <TextField 
                        fullWidth 
                        label="Capital simulado (USD)" 
                        type="number" 
                        value={bankroll} 
                        onChange={(e) => setBankroll(parseFloat(e.target.value))}
                        helperText="A conta da corretora nunca é consultada"
                      />
                    </Grid>
                    <Grid size={{ xs: 12 }}>
                      <Button 
                  ...
                  {kellyError && (
                    <Alert severity="warning" sx={{ mt: 2 }}>{kellyError}</Alert>
                  )}
                ...
                <CardContent>
                  ...
                  <Box sx={{ mb: 3 }}>
                    ...
                    <Alert severity="info" variant="outlined" sx={{ borderRadius: 2 }}>
                      ATOM Research não consulta saldo, posições nem alavancagem na Binance
                      (HTTP 410). Kelly usa apenas o capital simulado informado ao lado.
                    </Alert>
                  </Box>
                  ...
                  <Box sx={{ borderLeft: '2px solid #6366f1', pl: 2, py: 1 }}>
                    ...
                    <Typography variant="body2">
                      • Sizing teórico: <strong>fractional Kelly</strong> no capital simulado — não é ordem.
                    </Typography>
                  </Box>
