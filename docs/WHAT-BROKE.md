...
| ETH/SOL paper stat-arb | EG gate + OU half-life + rolling z + paper bid/ask book + kill flatten | Full-sample gate looks at the sample; synthesized book is not firm; **no broker** |
